...
var x = setInterval(function () {
  ...
  var seconds = Math.floor(distance % (1000 * 60) / 1000); // Output the result in an element with id="display-countdown"

  document.getElementById("display-countdown").innerHTML = days + " : " + hours + " : " + minutes + " : " + seconds; // If the count down is over, write some text 
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkspot"] = self["webpackChunkspot"] || [];
